...
const SERVICES_DROPDOWN_DATA = [
  {
    ...
    services: [
      ...
      { name: "Shoulder Pain Treatment", href: "/services/shoulder-pain-treatment/" },
      { name: "Elbow Pain Treatment", href: "/services/elbow-pain-treatment/" },
      { name: "Hip Pain Treatment", href: "/services/hip-pain-treatment/" },
      { name: "Wrist Pain Treatment", href: "/services/wrist-pain-treatment/" },
      { name: "Foot Pain Treatment", href: "/services/foot-pain-treatment/" },
      { name: "Muscle Pain Treatment", href: "/services/muscle-pain-treatment/" },
      { name: "Neck Pain Treatment", href: "/services/neck-pain-treatment/" },
      { name: "Post-Accident Rehabilitation", href: "/services/post-accident-rehabilitation/" },
      { name: "Frozen Shoulder Treatment", href: "/services/frozen-shoulder-treatment/" },
      { name: "Osteoarthritis Treatment", href: "/services/osteoarthritis-treatment/" },
      { name: "Carpal Tunnel Syndrome Treatment", href: "/services/carpal-tunnel-syndrome-treatment/" },
  ...
  },
  {
    ...
    services: [
      ...
      { name: "Alzheimer's Treatment", href: "/services/alzheimers-treatment/" },
      { name: "Spinal Cord Injury Rehabilitation", href: "/services/spinal-cord-injury-rehabilitation/" },
      { name: "Diabetic Neuropathy Treatment", href: "/services/diabetic-neuropathy-treatment/" },
      { name: "Myasthenia Gravis Treatment", href: "/services/myasthenia-gravis-treatment/" },
      { name: "Meningitis Rehabilitation", href: "/services/meningitis-rehabilitation/" },
      { name: "Encephalitis Treatment", href: "/services/encephalitis-treatment/" },
  ...
  },
  {
    ...
    services: [
      ...
      { name: "MCL Injury Rehabilitation", href: "/services/mcl-injury-rehabilitation/" },
      { name: "PCL Injury Rehabilitation", href: "/services/pcl-injury-rehabilitation/" },
      { name: "Golfer's Elbow Treatment", href: "/services/golfers-elbow-treatment/" },
      { name: "Tennis Elbow Treatment", href: "/services/tennis-elbow-rehabilitation/" },
      { name: "Ligament Injury Rehabilitation", href: "/services/ligament-injury-rehabilitation/" },
      { name: "Meniscus Injury Rehabilitation", href: "/services/meniscus-injury-rehabilitation/" },
      { name: "Patella Mobilization Therapy", href: "/services/patella-mobilization-therapy/" },
      { name: "Sprain Rehabilitation", href: "/services/sprain-rehabilitation/" },
      { name: "Strain Rehabilitation", href: "/services/strain-rehabilitation/" },
      { name: "Muscle Spasm Treatment", href: "/services/muscle-spasm-treatment/" },
      { name: "Muscle Stiffness Treatment", href: "/services/muscle-stiffness-treatment/" },
    ],
  },
];
