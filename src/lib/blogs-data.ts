...
export const BLOG_ARTICLES: BlogArticle[] = [
  ...
  },
  {
    ...
    body: [
      ...
      "Dr. Rohit Kumar brings portable clinical equipment — including resistance bands, balance boards, TENS units, and ultrasound devices — directly to the patient's home, ensuring clinic-grade treatment quality without the travel burden.",
